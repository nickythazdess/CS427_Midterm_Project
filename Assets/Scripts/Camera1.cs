...
public class Camera1 : MonoBehaviour
{
    ...
    private Vector2 Cave1_bottom_left = new Vector2(-1.7f, -14.11f);
    private Vector2 Cave1_top_right = new Vector2(16.71f, 0.15f);
    ...
    private Vector2 Other_bottom_left = new Vector2(39.25f, -32.2f);
    private Vector2 Other_top_right = new Vector2(156.68f, 41.15f);
